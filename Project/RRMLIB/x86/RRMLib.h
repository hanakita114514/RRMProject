...
namespace RRMLib
{
	...
	//void DrawRectGraph(float destX, float destY, int srcX, int srcY,
	//	int width, int height, DrawingStructure drawData, bool transFlag, bool trunFlag);
	...
	//void DrawExtendGraph(float lx, float ly, float rx, float ry, DrawingStructure drawData);
	...
	//void DrawRectExtendGraph(float destLX, float destLY, float destRX, float destRY,
	//	int srcX, int srcY, int width, int height, DrawingStructure drawData, bool transFlag, bool turnFlag);
