...
PlayerHitBox::ThirdAttack(float frame, const Rect&rc, const Vector2& dir)
{
	const HitBox hitBox[] =
	{
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((390 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((380 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((370 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((360 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((350 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((340 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((330 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((320 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((310 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((300 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((290 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((280 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((270 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((260 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((250 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((240 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((230 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((220 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((210 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((200 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((190 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((180 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((170 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((160 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((150 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((140 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
		HitBox(20, 4, Rect(Position(rc.pos.x + ((dir.x == -1 ? 50 : rc.w) * dir.x + ((130 + 5) * dir.x)), rc.pos.y), 50 , 50),  Vector2(8 * dir.x, -5)),
